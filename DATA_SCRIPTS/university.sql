CREATE TABLE STUDENTS (
    ...
    CONSTRAINT CK_STUDENTS_EMAIL_FORMAT CHECK (REGEXP_LIKE(email, '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$')),
...
CREATE TABLE LECTURERS (
    ...
    email VARCHAR2(50) NOT NULL,
    phone_number VARCHAR2(12) NOT NULL,
    CONSTRAINT CK_LECTURERS_EMAIL_FORMAT CHECK (REGEXP_LIKE(email, '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$')),
...
CREATE TABLE BUILDINGS (
    ...
    street VARCHAR2(20) NOT NULL,
    building_number VARCHAR2(3) NOT NULL,
    postal_code VARCHAR2(6) NOT NULL,
...
CREATE INDEX idx_students_pesel ON STUDENTS(PESEL);
CREATE INDEX idx_students_phone_number ON STUDENTS(phone_number);


CREATE INDEX idx_lecturers_email ON LECTURERS(email);
CREATE INDEX idx_lecturers_phone_number ON LECTURERS(phone_number);
